...
public class GaugeView extends View {
    ...
    public static final float OUTER_SHADOW_WIDTH = 0.00f;
    public static final float OUTER_BORDER_WIDTH = 0.005f;
    ...
    public static final float TEXT_UNIT_SIZE = 0.25f;
